...
class Sketchpad {
 public:
  ...
  // Gets the handwritten image representation of what has been drawn
  HandwrittenImage GetHandwrittenImage() const;
 private:
  static const char kShadedChar = '#';
  static const char kUnshadedChar = ' ';
  ...
  vector<vector<char>> encoded_image_;
};
